...
cp config/env/.env.public.example .env.public
```
...
```bash
apps/           → api, admin, public uygulamaları
...
TT Panel geliştirme süreci fazlara ve sprintlere bölünmüştür.  
Tam yol haritası ve sprint planı için:  
[📄 05-roadmap.md](docs/gpt/system/05-roadmap.md)
